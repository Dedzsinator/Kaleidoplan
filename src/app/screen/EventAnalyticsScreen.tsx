    ...
    <div className="analytics-container">
      <div className="analytics-header">
        ...
        <div className="analytics-actions">
          <Link to={`/events/edit/${eventId}`} className="edit-event-button">
            Edit Event
          </Link>
          <button className="export-button" onClick={handleExportCSV} disabled={exportLoading}>
        ...
        <>
          ...
          <div className="analytics-summary">
            ...
            <div className="summary-card">
              ...
              <p className="summary-value">{analytics && (analytics.engagement.clickThroughRate * 100).toFixed(1)}%</p>
            </div>
          </div>
                  ...
                  <tbody>
                    {analytics.demographics.location.map((loc, index) => (
                      <tr key={index}>
                        <td>{loc.city}</td>
                        <td>{loc.count}</td>
                        <td>{((loc.count / analytics.registrations.total) * 100).toFixed(1)}%</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
